...
if(apellido==""){
alert("SELECCIONE UNA INVERSION");}
else{
...
var cadena = "cargarcobro22.php?prestamo="+prestamo+"&idcliente="+idcliente+"&fecha="+fechahoy+"&numerocarga="+numcargamenos;
var cadena2 = "&";


var sibandera = 0;
for(x=0; x < numcargamenos; x++){
if(document.form1.importe[x].value!="" && document.form1.cuota[x].value!=""){
sibandera= 1;
}else{
sibandera= 0;
break;
...
var idcliente = document.form1.idcliente.value;
var numcargamenos = document.form1.numcarga.value - 1;
var cadena = "cargarcobro.php?prestamo="+prestamo+"&idcliente="+idcliente+"&fecha="+fechahoy+"&numerocarga="+numcargamenos;
var cadena2 = "&";
...
?>
 ...
 <form name="form1" method="post" action="">
     ...
     <input name="prestamo" style="display: none;"  readonly  type="text"  size="10"  id="prestamo" >  <input name="numcarga"  style="display: none;" type="text" id="numcarga"   readonly="readonly" >
            FECHA:<input value=<? echo date("d-m-Y");?> size="10" id="fc_1324699544" type="text"  name="fechahoy" title="DD-MM-YYYY" >
 <input name="idcliente" style="display: none;" size="5" type="text" id="idcliente" readonly>
      <table align="center"><tr><td>APELLIDO</td> <td>NOMBRE</td><td>DNI</td><TD>MONTO PRESTAMO</TD><TD>INTERES</TD><TD>PRODUCTO</TD></TR>
      ...
      <TD> <input name="dni" size="15" type="text" id="dni" readonly></TD>
          ...
          <TD> <input name="interes" size="15" type="text" id="interes" readonly></TD>
    ...
    <table align="center"><tr><td></td><td>CUOTA</td><td>IMPORTE</td><td>INTERES</td><td>FECHA VENCIMIENTO</td></TR>
       <TR>
    ...
    <input type="button" name="Submit22" value="COBRAR INTERES Y RENOVAR CAPITAL" onClick="finalizar2()">      
   <input type="button" name="Submit2" value="GUARDAR PAGO E IMPRIMIR" onClick="finalizar()"><BR>
