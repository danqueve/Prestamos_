...
<title>::CONSTANCIA DE CANCELACION DE PRESTAMO::</title>
...
<table width="700px" border="0">
  ...
  <tr>
    <td colspan="4" >CLIENTE:<B> <?php echo $apellido.", ".$nombre ;?></B><BR>DNI: <B><?php echo $dni;?></B> DIRECCION: <B><?php echo $direccion;?></B> </td>
  </tr>
...
if ($row = mysqli_fetch_array($result26)){ 
  ...
  $total=$total + $row["importe"];
	  ...
	  echo "<tr><td colspan='8'><b>CUOTAS PAGADAS:</b>".$row["cuota"]."<b> FECHA PAGO:</b>".$row["fecha"]."<b> IMPORTE:$ </b>".$row["importe"]."</td><td colspan='8'><HR></TD></tr>";
...
<tr><td colspan="4"><hr color="#000000"></td></tr>
 ...
 <tr><td  bgcolor="#999999">TOTAL</td><td colspan="2"><?php echo numtoletras($total);?> </td>  <td> <B>$   <?php echo $total;?></B>   </td>  </tr>
</table>
</TD></TR></TABLE>
