...
if( $data[$y]['dias']>0) {$data[$y]['dias']=  $data[$y]['dias']. " DIAS";}else{$data[$y]['dias']= abs($data[$y]['dias']). " DIAS PARA VENCER";}
...
$titles = array(
				...
				'dni'=>'<b>dni</b>',
								...
								'celular'=>'<b>celular</b>',
								'trabajo'=>'<b>trabajo</b>',
								'telefonotrabajo'=>'<b>tel trab1</b>',
									'telefono2'=>'<b>tel trab2</b>',
									'interno'=>'<b>interno</b>',
