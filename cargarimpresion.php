...
.Estilo4 {font-size: xx-small; writing-mode: vertical-lr;
    transform: rotate(180deg); height: 24em;}
-->
</style>
...
?>
<table  width="700px" height="200px" border="1">
  <tr ><td rowspan="3" ><span class="Estilo4">FECHA PAGO:...../...../.........($......................)<br><B>IMP:</B><?php echo $apagar[$i];?>&nbsp;<B>INT:</B><?php echo $interesd[$i];?>&nbsp;<B>TOT:</B><?php echo $totalimp;?><br><B>CUOTA N°:</B><?php echo $numcuota[$i]."/".$cuotasprestamo;?>&nbsp;<B>F.VEN:</B><?php echo $fechacuota[$i];?><B>PREST.N°:</B> <?php echo $prestamo;?>&nbsp;<br><b>DNI:</b><?php echo $dni;?><br><B>CLIENTE:</B><?php echo $apellido.", ".$nombre ;?><br><span class="Estilo2">TICKET</span></span></td>
      <td align="center" bgcolor="#CCCCCC">
    <span class="Estilo2">TICKET</span><br> <span class="Estilo3">
         PRESTAMO N°: <?php echo $prestamo;?>&nbsp; MONTO INICIAL:$ <?php echo $montoprestamo;?> 
        N° DE CUOTAS: <?php echo $cuotasprestamo;?> </span><br><span class="Estilo3">CLIENTE:<B> <?php echo $apellido.", ".$nombre ;?></B>&nbsp;DNI: <B><?php echo $dni;?></B> &nbsp;DIRECCION: <B><?php echo $direccion;?></B></span>  </td><td><img src="logo.jpg" width="90px" ></td>
   
  </tr>

<?php echo "<tr ><td colspan='2' ><span class='Estilo3'><b>CUOTA:</b>".$numcuota[$i]."/".$cuotasprestamo."<b> FECHA VENC:</b>".$fechacuota[$i]."<b> IMPORTE:$</b>".$apagar[$i]."<b> INTERES:$ </b>".$interesd[$i]."<b> TOTAL:$ </b>".$totalimp."</span></td></tr><tr><td colspan='2' align=right><span class='Estilo3' >FECHA PAGO:......../....../...........($............................)FIRMA RESPONSABLE:........................................</span></td></tr><BR> </table>";
...
?>
 ...
 <?php $result1 = mysqli_query($link,"SELECT * FROM cuotas WHERE idprestamo='$prestamo' and estado='ADEUDADA'"); 
