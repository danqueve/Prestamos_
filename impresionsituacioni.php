...
<title>::IMPRESION SITUACION INVERSION::</title>
...
$result25 = mysql_query("SELECT * FROM inversiones WHERE id= '$idprestamo' order by id desc limit 1", $link); 
...
$result26 = mysql_query("SELECT * FROM inversores WHERE id= '$idcliente' order by id desc limit 1", $link); 
if ($row = mysql_fetch_array($result26)){ 
  ...
  <tr>
    <td colspan="4" align="center" bgcolor="#CCCCCC">
       <H3>SERVICIOS FINANCIEROS ELDORADO MISIONES</H3>
         PRESTAMO N°: <? echo $idprestamo;?><BR>FECHA:<? echo date("d-m-Y"); ?><BR> MONTO INICIAL: <? echo $monto;?> <br>
        N° DE CUOTAS: <? echo $cuotas;?> </span>    </td>
    
  </tr>
  <tr>
    <td colspan="4" ><hr>CLIENTE: <? echo $apellido.", ".$nombre ;?> &nbsp;DNI: <? echo $dni;?> - DIRECCION: <? echo $direccion;?></b><hr> </td>
  </tr>
...
require('conexionsql.php');
$total=0;
$result26 = mysql_query("SELECT * FROM cuotasi WHERE idprestamo= '$idprestamo' and idcliente= '$idcliente' and estado='ADEUDADA' order by id asc", $link); 
if ($row = mysql_fetch_array($result26)){ 
  ...
  $total=$total + $row["monto"]; 
   ...
   echo "<tr><td colspan='8'><b>CUOTA:</b>".$row["cuota"]."<b> FECHA VENC:</b>".$row["fecha"]."<b> IMPORTE:</b>".$row["monto"]."</td><td colspan='8'><HR></TD></tr>";
    ...
    <tr><td  bgcolor="#999999">TOTAL ADEUDADO:</td><td colspan="2"><? echo $total;?> </td>   </tr>
...
require('conexionsql.php');
$totalpagado=0;
$result26 = mysql_query("SELECT * FROM cobrosi WHERE idprestamo= '$idprestamo' and idcliente= '$idcliente'  order by id asc", $link); 
if ($row = mysql_fetch_array($result26)){ 
  ...
  $totalpagado=$totalpagado + $row["importe"]; 
   ...
   echo "<tr><td colspan='8'><b>CUOTAS:</b>".$row["cuota"]."<b> FECHA PAGO:</b>".$row["fecha"]."<b> IMPORTE:</b>".$row["importe"]."</td><td colspan='8'><HR></TD></tr>";
    ...
    <tr><td  bgcolor="#999999">TOTAL PAGADO:</td><td colspan="2"><? echo $totalpagado;?> </td>   </tr>
    <tr><td colspan="4"><hr color="#000000"></td></tr>
