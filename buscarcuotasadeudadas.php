...
<html> 
<head> 
<title>CONSULTA DE CUOTAS ADEUDADAS POR FILTROS</title> 
...
form{width:1050px; margin:auto; background: #999999;
padding:10px 20px;
...
#tabla2{
	...
	th,td{ padding:10px;}
	thead{ background:#666666; border-bottom: solid 5px #0f362d; color:#FFFFFF}
...
<H1>CONSULTAR CUOTAS ADEUDADAS</H1>

<form action="buscarcuotasadeudadas.php" method="get"> 
...
<form method="post" onSubmit="return chequear();" action="buscarcuotasadeudadas.php" name="recomienda">
<input type="Text" style="display: none;" readonly size="10" <?php echo "value='$c_id'" ?> name="id">
          ...
          IMPORTE  :<input  type="Text" size="40" <?php echo "value='$c_importe'"  ?> name="importem">
              FECHA  :<input  type="Text" size="40" <?php echo "value='$c_fecha'"  ?> name="fecham"> 
               MOTIVO MODIFICACION  :<input  type="Text" size="40" <?php echo "value='$c_motivo'"  ?> name="motivo"> 
...
<?php echo "<H1><a target='_blank' class='ord' href='"."pdfbuscarcuotasadeudadas.php?tabla=".$tabla."&dni=".$dnie."&fecha1=".$fechae1."&fecha2=".$fechae2."&prestamo=".$prestamoe."&apellido=".$apellidoe."&cantidadc=".$numeroRegistros."'>IMPRIMIR LISTADO</a></H1>"; 
