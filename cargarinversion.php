...
<title>::GUARDAR INVERSION - IMPRIMIR::</title>
...
<table width="700px" border="0">
  <tr>
    ...
    <H3>SERVICIOS FINANCIEROS ELDORADO MISIONES</H3>
         <b>INVERSION N°:</b> <? echo $c_prestamo;?>&nbsp;<b>FECHA:</b><? echo $fechainicio; ?>&nbsp;<b> MONTO INICIAL:$ </b> <? echo $monto;?>&nbsp;<b>
        N° DE CUOTAS:</b> <? echo $cuotas;?> </span>    </td>
    
  </tr>
  <tr>
    <td colspan="4" ><b class="beto2"><hr>INVERSOR: <? echo $apellido.", ".$nombre ;?> &nbsp; DNI: <? echo $dni;?> &nbsp; DIRECCION: <? echo $direccion;?></b><hr> </td>
  </tr>
...
require('conexionsql.php');
 $sql34 = "INSERT INTO inversiones (idcliente,  monto, interes, cuota, montofinal, fecha, fechasql, estado, observacion,observ) VALUES ('$idcliente', '$monto', '$interes','$cuotas','$final','$fechainicio','$fechainiciosql','PENDIENTE','$producto','$observ')";
...
$sqlfecha[$i]= trim(substr($fechacuota[$i],6,4)."-".substr($fechacuota[$i],3,2)."-".substr($fechacuota[$i],0,2));
 ...
 echo "<tr><td colspan='8'><b>CUOTA:</b>".$numcuota[$i]."<b> FECHA VENC:</b>".$fechacuota[$i]."<b> IMPORTE:$ </b>".$importe[$i]."</td></tr>";
	...
	$fssql=$sqlfecha[$i];
	  ...
	  $sql4 = "INSERT INTO cuotasi (idprestamo,  idcliente, cuota, monto, fecha, fechasql, estado) VALUES ('$c_prestamo', '$idcliente', '$numsql','$impsql','$fesql','$fssql','ADEUDADA')";
...
<TR><td colspan="4" height="5"></td></TR>
   ...
   <tr><td  bgcolor="#999999"><b class="beto2">TOTAL:</b><? echo numtoletras($total);?></td>
   <td colspan="2"><b class="beto2">$ <? echo $total;?> </b></td>  
   <td>     </td>  
   </tr>
