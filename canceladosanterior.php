...
$criterio = ""; 
$txt_criterio = ""; 
$criterio = " where (clientes.apellido like '%" . $txt_criterio . "%' or clientes.nombre like '%" . $txt_criterio . "%'or clientes.dni like '%" . $txt_criterio . "%') and (clientes.id=prestamos.idcliente) and (prestamos.estado='CANCELADO')"; 
if ($_GET["criterio"]!=""){ 
     ...
     <td><? echo $registro["observacion"]; ?></td> 
            <td><? echo $registro["estado"]; ?></td> 
             <td><? echo "<a target='_blank' class='ord' href='"."reimpresion.php?idprestamo=".$registro["idprestamo"]."'>REIMPRIMIR </a>"; ?></td>
                <td><? echo "<a target='_blank' class='ord' href='"."constancia.php?idprestamo=".$registro["idprestamo"]."'>IMPRIMIR CONSTANCIA </a>"; ?></td>
...
<? echo "<H1><a target='_blank' class='ord' href='"."pdfprestamos2.php?criterio=".$txt_criterio."&numeroprestamos=".$numeroRegistros."'>IMPRIMIR LISTADO</a></H1>"; ?>
